...
export const claudeAgentDiscordDescription: INodeTypeDescription = {
	displayName: 'Claude Agent Discord',
	name: 'claudeAgentDiscord',
	icon: 'file:claudeAgentDiscord.svg',
	group: ['transform'],
	version: 1,
	subtitle: 'Send Approval / Question and Wait',
	description: 'Send Claude Agent SDK HITL requests through Discord and wait for responses',
	defaults: {
		name: 'Claude Agent Discord',
	},
	...
	properties: [
		...
		},
		{
			...
			required: true,
			default: '',
			description: 'Destination Discord channel ID',
		},
		{
			displayName: 'Discord Application Public Key',
			...
			default: '',
			description:
				'Discord application public key (hex) used to verify inbound interaction signatures (X-Signature-Ed25519) before HITL replies are accepted. Found under Discord Developer Portal → your app → General Information → Public Key.',
		},
		{
		...
		},
		{
			...
			description: 'Controls primary HITL message text sent to Discord',
		},
		{
