...
export const claudeAgentGmailDescription: INodeTypeDescription = {
	displayName: 'Claude Agent Gmail',
	name: 'claudeAgentGmail',
	icon: 'file:claudeAgentGmail.svg',
	group: ['transform'],
	version: 1,
	subtitle: 'Send Approval / Question and Wait',
	description: 'Send Claude Agent SDK HITL requests through Gmail and wait for responses',
	defaults: {
		name: 'Claude Agent Gmail',
	},
	...
	properties: [
		...
		},
		{
			...
			required: true,
			default: '',
			description: 'Sender email address or alias available in Gmail account',
		},
		{
		...
		},
		{
			...
			description: 'Controls primary HITL message text sent to Gmail',
		},
		{
