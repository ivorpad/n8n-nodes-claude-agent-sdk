[Skip to content](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/#accessing-n8n-mcp-server)

[Edit this page](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/accessing-n8n-mcp-server.md "Edit this page")

# Accessing n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#accessing-n8n-mcp-server "Permanent link")
...
## Difference between instance-level MCP access and MCP Server Trigger node [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#difference-between-instance-level-mcp-access-and-mcp-server-trigger-node "Permanent link")
...
### Key considerations when using instance-level MCP access [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#key-considerations-when-using-instance-level-mcp-access "Permanent link")
...
## Enabling MCP access [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#enabling-mcp-access "Permanent link")

### For Cloud and self-hosted instances [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#for-cloud-and-self-hosted-instances "Permanent link")

1. Navigate to **Settings > Instance-level MCP**
2. Toggle **Enable MCP access** (requires instance owner or admin permissions).

![enable-mcp-access.png](https://docs.n8n.io/_images/advanced-ai/enable-mcp-access.png)
...
![mcp_page_content.png](https://docs.n8n.io/_images/advanced-ai/mcp_page_content.png)

**To disable:** Toggle the main MCP toggle off.

### For self-hosted: Complete disablement [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#for-self-hosted-complete-disablement "Permanent link")
...
## Setting up MCP authentication [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#setting-up-mcp-authentication "Permanent link")
...
![mcp_connect_menu.png](https://docs.n8n.io/_images/advanced-ai/mcp_connect_menu.png)

### Using OAuth2 [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#using-oauth2 "Permanent link")
...
#### Revoking client access [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#revoking-client-access "Permanent link")
...
![mcp_revoke_client_access.png](https://docs.n8n.io/_images/advanced-ai/mcp_revoke_client_access.png)

### Using Access Token [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#using-access-token "Permanent link")
...
#### Rotating your token [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#rotating-your-token "Permanent link")
...
![mcp_rotate_token.png](https://docs.n8n.io/_images/advanced-ai/mcp_rotate_token.png)

## Exposing workflows to MCP clients [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#exposing-workflows-to-mcp-clients "Permanent link")
...
### Enabling access [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#enabling-access "Permanent link")

#### Option 1: From MCP settings page (available from n8n v2.2.0) [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#option-1-from-mcp-settings-page-available-from-n8n-v220 "Permanent link")
...
#### Option 2: From the workflow editor [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#option-2-from-the-workflow-editor "Permanent link")
...
#### Option 3: From the workflows list [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#option-3-from-the-workflows-list "Permanent link")

1. Go to **Workflows**.
2. Open the menu on a workflow card.
3. Select **Enable MCP access**.

### Managing access [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#managing-access "Permanent link")
...
### Workflow descriptions [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#workflow-descriptions "Permanent link")
...
![mcp_workflow_description.png](https://docs.n8n.io/_images/advanced-ai/mcp_workflow_description.png)

## Executing workflows through MCP clients [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#executing-workflows-through-mcp-clients "Permanent link")
...
### Providing input data [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#providing-input-data "Permanent link")
...
### Workflow timeouts [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#workflow-timeouts "Permanent link")
...
### Limitations [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#limitations "Permanent link")
...
## Tools [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#tools "Permanent link")
...
### SDK and node reference [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#sdk-and-node-reference "Permanent link")
...
### Workflow creation and validation [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#workflow-creation-and-validation "Permanent link")
...
### Workflow introspection [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#workflow-introspection "Permanent link")
...
### Testing workflows [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#testing-workflows "Permanent link")
...
### Projects and folders [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#projects-and-folders "Permanent link")
...
## Resources [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#resources "Permanent link")
...
## Examples [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#examples "Permanent link")

#### Connecting Lovable to n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#connecting-lovable-to-n8n-mcp-server "Permanent link")
...
#### Connecting Claude Desktop to n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#connecting-claude-desktop-to-n8n-mcp-server "Permanent link")

##### Using OAuth2 [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#using-oauth2_1 "Permanent link")
...
##### Using Access Token [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#using-access-token_1 "Permanent link")
...
|     |     |
| --- | --- |
| ```<br>1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>``` | ```<br>"mcpServers": {<br>  "n8n-local": {<br>    "type": "http",<br>    "url": "https://<your-n8n-domain>/mcp-server/http",<br>    "headers": {<br>      "Authorization": "Bearer <YOUR_N8N_MCP_TOKEN>"<br>    }<br>  }<br>}<br>``` |
...
### Connecting Claude Code to n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#connecting-claude-code-to-n8n-mcp-server "Permanent link")

Use the following CLI command:

|     |     |
| --- | --- |
| ```<br>1<br>2<br>``` | ```<br>claude mcp add --transport http n8n-mcp https://<your-n8n-domain>/mcp-server/http \<br>  --header "Authorization: Bearer <YOUR_N8N_MCP_TOKEN>"<br>``` |

Alternatively, add the following entry to your `claude.json` file:

|     |     |
| --- | --- |
| ```<br> 1<br> 2<br> 3<br> 4<br> 5<br> 6<br> 7<br> 8<br> 9<br>10<br>11<br>``` | ```<br>{<br>    "mcpServers": {<br>        "n8n-local": {<br>            "type": "http",<br>            "url": "https://<your-n8n-domain>/mcp-server/http",<br>            "headers": {<br>                "Authorization": "Bearer <YOUR_N8N_MCP_TOKEN>"<br>            }<br>        }<br>    }<br>}<br>``` |
...
### Connecting Codex CLI to n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#connecting-codex-cli-to-n8n-mcp-server "Permanent link")

Add the following entry to your `~/.codex/config.toml` file:

|     |     |
| --- | --- |
| ```<br>1<br>2<br>3<br>``` | ```<br>[mcp_servers.n8n_mcp]<br>url = "https://<your-n8n-domain>/mcp-server/http"<br>http_headers = { "authorization" = "Bearer <YOUR_N8N_MCP_TOKEN>" }<br>``` |
...
### Connecting Google ADK agent to n8n MCP server [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#connecting-google-adk-agent-to-n8n-mcp-server "Permanent link")

Here's sample code to create an agent that connects to a remote n8n MCP server:

|     |     |
| --- | --- |
| ```<br> 1<br> 2<br> 3<br> 4<br> 5<br> 6<br> 7<br> 8<br> 9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>``` | ```<br>from google.adk.agents import Agent<br>from google.adk.tools.mcp_tool import McpToolset<br>from google.adk.tools.mcp_tool.mcp_session_manager import StreamableHTTPServerParams<br>N8N_INSTANCE_URL = "https://localhost:5678"<br>N8N_MCP_TOKEN = "YOUR_N8N_MCP_TOKEN"<br>root_agent = Agent(<br>    model="gemini-2.5-pro",<br>    name="n8n_agent",<br>    instruction="Help users manage and execute workflows in n8n",<br>    tools=[<br>        McpToolset(<br>            connection_params=StreamableHTTPServerParams(<br>                url=f"{N8N_INSTANCE_URL}/mcp-server/http",<br>                headers={<br>                    "Authorization": f"Bearer {N8N_MCP_TOKEN}",<br>                },<br>            ),<br>        )<br>    ],<br>)<br>``` |

For more details, see [Connect ADK agent to n8n](https://google.github.io/adk-docs/tools/third-party/n8n/).

## Troubleshooting [\#](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/\#troubleshooting "Permanent link")
